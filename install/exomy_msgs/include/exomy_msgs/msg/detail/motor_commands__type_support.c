...
static rosidl_typesupport_introspection_c__MessageMember MotorCommands__rosidl_typesupport_introspection_c__MotorCommands_message_member_array[2] = {
  {
    ...
    offsetof(exomy_msgs__msg__MotorCommands, motor_velocities),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(exomy_msgs__msg__MotorCommands, steering_angles),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
